...
public class SendMailUtil {
    ...
    public static final String SENDER = "928956576@qq.com";//此处需要与host相同的网站
    public static final String SENDERPWD = "15522151220";
    ...
    public static void main(String[] args) {
        send("893072002@qq.com","<h2>请点击下面的链接激活帐号，链接只能使用一次，请尽快激活！</h2>");
    }
}
